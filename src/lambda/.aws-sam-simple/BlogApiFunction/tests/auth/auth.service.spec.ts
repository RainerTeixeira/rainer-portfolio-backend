...
import * as configMock from '../../src/common/config';
...
describe('AuthService', () => {
  ...
  beforeEach(async () => {
    ...
    const mockedResponse: AxiosResponse<{
      ...
      statusText: 'OK',
      headers: {} as AxiosRequestHeaders,
      // Config minimal apenas para satisfazer tipos do Axios
    ...
    // Injetar logger mockado para evitar undefined em métodos privados
  ...
  describe('decodeJWT', () => {
    it('should decode valid JWT token', () => {
      ...
      const decodeJWT = (Reflect.get(service as object, 'decodeJWT') as (t: string) => Record<string, unknown>).bind(service);
  ...
  describe('syncUserWithDatabase', () => {
    it('should create new user if not exists', async () => {
      ...
      const syncUserWithDatabase = (Reflect.get(service as object, 'syncUserWithDatabase') as (
        p: { sub: string; email?: string }
      ) => Promise<void>).bind(service);
      await expect(syncUserWithDatabase(payload)).resolves.toBeUndefined();
    ...
    it('should not create user if already exists', async () => {
      ...
      const syncUserWithDatabase = (Reflect.get(service as object, 'syncUserWithDatabase') as (
        p: { sub: string; email?: string; name?: string; nickname?: string }
      ) => Promise<void>).bind(service);
      await syncUserWithDatabase(payload);
  ...
  describe('handleOAuthCallback', () => {
    ...
    it('should throw error for invalid code', async () => {
      ...
      const invalidConfig: AxiosRequestConfig = { headers: {} as AxiosRequestHeaders };
