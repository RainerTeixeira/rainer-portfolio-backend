...
├── technical-details.json   # Detalhes técnicos (endpoints, scripts)
...
Execute `npm run memory:update` após:

1. ✅ Mudança de versão no `package.json`
2. ✅ Reorganização de estrutura (pastas, arquivos)
3. ✅ Adição de novos módulos ou funcionalidades
4. ✅ Mudança em dependências principais
5. ✅ Atualização de métricas (cobertura, testes)
6. ✅ Reorganização de scripts

### Atualização Manual

Se preferir atualizar manualmente, edite os arquivos JSON diretamente em `docs/.memories/`.

## 🤖 Integração com Ferramentas

### Cursor IDE

O arquivo `.cursorrules` na raiz instrui o Cursor a:
...
- Arquitetura (NestJS, Fastify, etc.)
...
Contém:
- **Endpoints**: Lista completa de 65 endpoints
- **Módulos**: Funcionalidades de cada módulo
- **Scripts**: Scripts disponíveis organizados
- **Configuração**: Variáveis de ambiente
- **Organização**: Estrutura de pastas
- **Qualidade**: Métricas de cobertura
...
# (adicionar módulo, mudar estrutura, etc.)
...
- [Análise da Raiz](../ANALISE_RAIZ.md)
- [Guia de Navegação](../01-NAVEGACAO/GUIA_NAVEGACAO.md)
